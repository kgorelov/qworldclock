...
flowchart TD
    ...
    MainWin --> MenuToolbar[Menu & Edit Toolbar]
...
- **Edit Mode** (toggled via Toolbar button, `Ctrl+E`, or context menu):
  ...
  - A bottom or top bar displays "Editing Layout — Click '+' to add adjacent clock or drag to reorder. [Done]".
...
- Implement Edit Mode toggle in `MainWindow` (toolbar, menu, `Ctrl+E`).
